...
public class MultiFileAvroGenerator {
    ...
    public MultiFileAvroGenerator(GeneratorConfig config, FileUtils fileUtils) {
        this.config = config;
        this.fileUtils = fileUtils;
    }

    public void generateMessage(Components components) {
        ...
        for (Map.Entry<String, Message> entry : components.getMessages().entrySet()) {
            map.put(entry.getKey(), generateMessage(entry.getKey(), entry.getValue(), components.getSchemas()));
        }
    ...
    private String generateModelClass(String className, Definition definition, Map<String, Definition> schemas) {
        ...
        if (definition.getProperties() != null && !definition.getProperties().isEmpty()) {
            ...
            for (Map.Entry<String, Definition> entry : definition.getProperties().entrySet()) {
                sb.append(generateAttribute(entry.getKey(), className, entry.getValue(), schemas));
                sb.append(",");
        ...
        if (definition.getOneOf() != null && !definition.getOneOf().isEmpty()) {
            ...
            for (Definition def : definition.getOneOf()) {
                ...
                sb.append(generateAttribute(attributeName, className2, def2, schemas));
                sb.append(",");
                sb.append(System.lineSeparator());
            }
            fields.add(sb.substring(0, sb.lastIndexOf(",")));
        ...
        if (fields.isEmpty() && definition.getEnumeration() != null && !definition.getEnumeration().isEmpty()) {
            ...
            if (definition.getReference() != null) {
                ...
                sb.append(generateAttribute(className2, className, def, schemas));
                sb.append(",");
                sb.append(System.lineSeparator());
            } else {
    ...
    private String generateMessage(String className, Message message, Map<String, Definition> schemas) {
        StringBuilder sb = new StringBuilder();
        sb.append("{");
        sb.append(System.lineSeparator());
        sb.append("\t\"namespace\": \"").append(config.getModelPackage()).append("\",");
        ...
        sb.append("\t\"fields\": [");
        sb.append(System.lineSeparator());
        sb.append(generateAttribute("header", className, message.getHeaders(), schemas));
        sb.append(",");
        sb.append(System.lineSeparator());
        sb.append(generateAttribute("payload", className, message.getPayload(), schemas));
        sb.append(System.lineSeparator());
        sb.append("\t]");
        sb.append(System.lineSeparator());
        sb.append("}");
    ...
    private String generateAttribute(String fieldName, String className, Definition definition, Map<String, Definition> schemas) {
        StringBuilder sb = new StringBuilder();
        sb.append("\t\t{");
        sb.append(System.lineSeparator());
        ...
        sb.append("\t\t\t\"type\": [");
        sb.append(System.lineSeparator());
        sb.append(generateDataType("object".equalsIgnoreCase(definition.getType()) ? className : definition.getType(), definition, schemas));
        sb.append(System.lineSeparator());
        sb.append("\t\t\t]");
        sb.append(System.lineSeparator());
        sb.append("\t\t}");
    ...
    private String generateDataType(String className, Definition definition, Map<String, Definition> schema) {
        StringBuilder sb = new StringBuilder();
        if (definition.getReference() != null) {
